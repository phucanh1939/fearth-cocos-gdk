...
-keepnames class org.jetbrains.annotations.**
-dontwarn java.beans.**

# Keep Wallet Core JNI bindings
-keep class wallet.core.jni.** { *; }

# Keep all native methods (used for JNI)
-keepclasseswithmembernames class * {
    native <methods>;
}

# Prevent obfuscation of Wallet Core classes
-keepnames class wallet.core.jni.** { *; }

# Ignore warnings related to JNI
